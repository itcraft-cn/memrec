...
mod tests {
    ...
    fn test_install_options_default() {
        let opts = InstallOptions { repo_url: None, allow_any_repo: false };
    ...
    fn test_install_options_custom_repo() {
        let opts = InstallOptions { repo_url: Some("https://gitee.com/itcraft-cn/memrec".to_string()), allow_any_repo: false };
